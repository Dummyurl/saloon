		  ...
		  ?>
            <li>
              <div class="switch demo4 service<?php echo $i; ?>">
                <input id="service<?php echo $i; ?>" class="service_check" type="checkbox" name="services[]" <?php echo ($servicename==$service[1] ? "checked":"" ); ?> value="<?php echo trim($service_details); ?>">
           ...
           <!-- <script>
            $(document).ready(function(){
              $('.service_check').click(function(){
                ...
                $.ajax({
                  type:'POST',
                  url: '<?php //echo base_url('webservices/get_staff_list'); ?>',
