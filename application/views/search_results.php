    ...
    <div class="col-md-12 search-rslt-hding">
      ...
      <div class="col-md-4">
        ...
        <div class="srch-rslt-lft-location">
              <h2>LOCATION</h2>
              <div class="srchlocation-input">
                <input type="text" value="<?php echo $_POST['location'];?>" name="location" class="form-control filter-field" placeholder="Type to filter( eg: Cochin)" aria-describedby="basic-addon1" >
              </div>
        </div>   
