    ...
    <div id="cd-signup">
      <form class="cd-form validate" id="signUp">
        ...
        <p class="fieldset">
          ...
          <input class="full-width has-padding has-border required" value="" id="signup-password" name="phone_no" type="text" placeholder="Phone">
...
<div class="container nav-row">
      ...
      <div class="col-lg-3">
		<div class="logo-main col-lg-12 col-xs-4">
			<a href="<?php echo base_url();?>">
				<img src="<?php echo base_url();?>assets/images/salon-logo.png" class="img-responsive" alt="logo"/>
			</a>
		</div>
      </div>
      <div class="col-lg-9 pad-none-1">
		...
		<?php if(isset($user_data)) { ?>
          ...
          <div class="in  pull-right">
            ...
            <div class="col-sm-6 col-xs-6 padding0 pull-right">
        ...
        <?php } ?>
		 <nav class="navbar navbar-default nav-secondary pull-right">
  ...
  <!--<div class="col-lg-4 second-sec-nav ">
    <div class="row">
      ...
      <div class="col-lg-6 col-xs-5 pad-none pull-right">
