            ...
            <div class="content-container">
                <form role="form" method="post" class="validate" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="controls">
                        <select id="selectError" class="col-md-10" data-rel="chosen" name="shop_id">
                            <?php
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="controls">
                        <select id="selectError" class="select_fileds col-md-10" data-rel="chosen" name="service_id">
                            <?php
...
<script>
    $('.select_fileds').change(function(){
        ...
        $.ajax({
            type:'POST',
            url: '<?php echo base_url('service/view_subcategory_ajax'); ?>',
            data:{id:id},
            dataType:'json',
